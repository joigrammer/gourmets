<div class="grid grid-cols-7 gap-6">
    <div class="col-span-12">
        ...
        <input type="text" name="name" id="name" class="form-input mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" value="{{ old('name', isset($meal->name) ? $meal->name : null) }}">
        @error('name')
