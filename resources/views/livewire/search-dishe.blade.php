    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8"> 
			<div class="flex justify-content">
				<input wire:model="search" type="search" name="serch" placeholder="Search" class="mx-auto bg-white h-10 px-5 pr-5 rounded-full  mb-16 text-sm focus:outline-none w-3/6">		
			</div>		    	
			<div class="grid sm:grid-cols-2 grid-flow-row gap-2">
				@foreach($dishes as $dishe)
					<div class="relative max-h-full">						
						...
						<div class="max-w-4xl h-full px-10 py-6 bg-white rounded-lg shadow-md">
							...
							<div class="mt">
								<a href="{{ route('cookbook.dishe.show', $dishe->slug) }}" class="text-2xl text-gray-700 font-bold hover:underline">
									{{ $dishe->name }}
								</a>
